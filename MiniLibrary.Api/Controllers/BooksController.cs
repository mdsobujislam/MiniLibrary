...
namespace MiniLibrary.Api.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] Book dto) { var exist = await _repo.GetBookByIdAsync(id); if (exist == null) return NotFound(); dto.BookId = id; dto.Status = dto.CopiesAvailable > 0; await _repo.UpdateBookAsync(dto); return NoContent(); }
